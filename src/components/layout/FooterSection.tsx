...
export default function FooterSection() {
  ...
  return (
    <footer className="vsp-red-sync relative mt-auto overflow-hidden pb-0">
      <div className="relative mx-auto max-w-6xl px-4 pb-0 pt-10 sm:pt-12">
        ...
        <div className="grid min-h-[64px] items-center gap-3 py-0 text-xs text-white/74 md:grid-cols-3">
